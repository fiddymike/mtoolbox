...
switch (Read-Host "
    ...
    1, 2, 3, 4, 5 or 6?") 
    {
        ...
        6 { $Global:NADServer = 'dc6.convera.com' }
...
function Set-UserFull ()
{
    ...
    switch -regex (Read-Host "[y/n]") {
        ...
        "n" { Write-Host "
            ...
            $Script:NUPN = $NUsername + $NADDomain
            }
    }
...
$Global:NVoiceMailSetup = 'https://confluence.ntent.com/display/DOC/Phones'
...
$Global:NBADServer = "DC7.convera.com"
...
Invoke-Item C:\users\mbennett\Desktop\PSReports\
}
...
Username: <span style="color: #cd3427;">$Nusername</span><br>
<br>
<strong>Microsoft Lync</strong><br>
Username: <span style="color: #cd3427;">$NEmailAddress</span><br>
<br>
<strong>Pidgin</strong><br>
Protocol: XMPP<br>
Username: <span style="color: #cd3427;">$NUsername</span><br>
Domain: <span style="color: #cd3427;">$NPidginDomain</span><br>
<br>
<br>
...
$NBOdy | out-file "$Muser\desktop\Welcome Email\Welcome Email $(Get-Date -f "MM-dd hhmm-ss").doc"3
}
...
Export-ModuleMember -function Get-UserAuditO365
...
Export-ModuleMember -alias gmce